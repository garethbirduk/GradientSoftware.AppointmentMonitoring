...
dotnet script ./GradientSoftware.GithubScripts/.github/scripts/update-version.csx %GITHUB_USERNAME% GradientSoftware.AppointmentMonitoring %GITHUB_APIKEY% .\AppointmentMonitoring\AppointmentMonitoring.csproj %branch%
